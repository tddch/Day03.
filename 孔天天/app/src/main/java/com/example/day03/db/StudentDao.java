...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Btn = new Property(3, String.class, "btn", false, "BTN");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Student entity) {
        ...
        String btn = entity.getBtn();
        if (btn != null) {
            stmt.bindString(4, btn);
        }
    }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // btn
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setBtn(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
